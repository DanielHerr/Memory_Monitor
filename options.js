...
chrome.storage.sync.get({
  clickpanel: true, clickbar: false, autopanel: false, low: 0,
  ...
  browserinterval: 1, panelinterval: 1, barinterval: 1, panelsize: 20, barsize: 20
}, function(items) {
...
chrome.system.memory.getInfo(function(memory) {
  document.querySelector("#capacity").textContent = (Math.round(memory.capacity / 1024 / 1024 / 100 )) / 10;
});
